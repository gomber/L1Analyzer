...
#)
#
#process.p = cms.Path(process.l1tCaloLayer1Digis*process.simCaloStage2Layer1Digis*process.L1Stage3Producer) #*process.rctDigis
process.p = cms.Path(process.l1tCaloLayer1Digis*process.uct2016EmulatorDigis*process.L1Stage3Producer) #*process.rctDigis
